...
class Service(dbus.service.Object):
    ...
    def GetAll(self, interface):
        if interface != constants.GATT_SERVICE_INTERFACE:
            raise exceptions.bluetooth_exceptions.InvalidArgsException()
...
class Characteristic(dbus.service.Object):
    ...
    @dbus.service.method(constants.GATT_CHARACTERISTIC_INTERFACE, in_signature='aya{sv}')
...
class Descriptor(dbus.service.Object):
    ...
    @dbus.service.method(constants.GATT_DESCRIPTOR_INTERFACE, in_signature='aya{sv}')
    def WriteValue(self, value, options):
        print('Default WriteValue called, returning error')
